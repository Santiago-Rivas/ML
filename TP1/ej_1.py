...
def main():
    ...
    prob_cond_ingleses = calcular_probabilidades_condicionales(ingleses, total_ingleses)
    prob_cond_escoceses = calcular_probabilidades_condicionales(escoceses, total_escoceses)
    ...
    resultado = clasificar(x_1, prob_cond_ingleses,prob_cond_escoceses, prior_ingleses, prior_escoces)
    ...
    resultado = clasificar(x_2, prob_cond_ingleses,prob_cond_escoceses, prior_ingleses, prior_escoces)
